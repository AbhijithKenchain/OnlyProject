...
public void restaurantEdit(String resNameEdit,String emailEdit,String phoneEdit,String WebsiteEdit,WebDriverUtils1 w,String OpenHours,String CloseHours,String Opendays,String category,String imgPath,String addressEdits)
{
...
public void redstaurantcancelbtnClick()
{
	CancelBtn.click();
}
public void logout()
